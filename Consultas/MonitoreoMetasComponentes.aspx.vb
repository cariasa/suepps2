...
Partial Class Consultas_MonitoreoMetasComponentes
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        ...
        SqlDataSourceMetasComponentes.SelectParameters(0).DefaultValue = idComponente
        ...
        "WHERE mdp.Peso<>0 AND [IdComponentesDePolitica]=@IdComponentesDePolitica " & _
    ...
    Protected Sub ASPxGridViewMetasComponentes_HtmlDataCellPrepared(sender As Object, e As ASPxGridViewTableDataCellEventArgs)
    ...
    Protected Sub link1_Click(sender As Object, e As EventArgs)
        ...
        Dim name As String = ASPxGridViewMetasComponentes.GetRowValues(index, "Nombre").ToString

        Dim idMeta As String = ASPxGridViewMetasComponentes.GetRowValues(index, "IdMetasDeComponente").ToString

        Dim porM As String = ASPxGridViewMetasComponentes.GetRowValues(index, "PorcentajeEjecucion").ToString


        Response.Redirect("MonitoreoIndicadoresMetas.aspx?NameP=" + uf.QueryStringEncode(politica) + "&CodP=" + uf.QueryStringEncode(idPolitica) + "&Porc=" + uf.QueryStringEncode(porcentaje) + "&CodC=" + uf.QueryStringEncode(idComponente) + "&NameC=" + uf.QueryStringEncode(componente) + "&PorcC=" + uf.QueryStringEncode(porcentajeC) + "&CodM=" + uf.QueryStringEncode(idMeta) + "&NameM=" + uf.QueryStringEncode(name) + "&PorM=" + uf.QueryStringEncode(porM))
    End Sub
End Class
