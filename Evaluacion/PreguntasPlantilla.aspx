...
<asp:Content ID="cBody" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div>
        ...
        <dx:ASPxGridView ID="GridPreguntas" runat="server" AutoGenerateColumns="False" 
            DataSourceID="SqlPreguntas" KeyFieldName="IdPreguntaPorPlantilla">
            <Columns>
       ...
       <asp:SqlDataSource runat="server" ID="SqlDataSourceOpciones" ConnectionString='<%$ ConnectionStrings:SUEPPSConnectionString %>' 
                    ...
                    InsertCommand="Insert INTO [OpcionesPreguntaPorPlantilla] ([Opcion], [IdPreguntaPorPlantilla], [CreadoPor], [FechaCreacion], [Activo],[Valor],[SaltaACodigo]) VALUES (@Opcion, @IdPreguntaPorPlantilla, @Usuario, getDate(), 1,@Valor,@SaltaACodigo)"
                    UpdateCommand="Update [OpcionesPreguntaPorPlantilla] SET [Opcion]=@Opcion, [ActualizadoPor]=@Usuario, [FechaActualizacion]=getDate(),[Valor]=@Valor,[SaltaACodigo]=@SaltaACodigo WHERE [IdOpcionPreguntaPorPlantilla] = @IdOpcionPreguntaPorPlantilla"
