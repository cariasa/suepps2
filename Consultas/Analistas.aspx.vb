...
Partial Class Consultas_suepps_analiprograma
    ...
    Protected Sub send(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Response.Redirect("Analizar.aspx?NameP=" + uf.QueryStringEncode(nameproyecto) + "&CodP=" + uf.QueryStringEncode(codproyecto))
