                    ...
                    <ContentCollection>
                        <dx:ContentControl>
                            ...
                            <asp:SqlDataSource runat="server" ID="SqlDataSourceSUEPPS" ConnectionString='<%$ ConnectionStrings:SUEPPSConnectionString %>' OnInserted="SqlDataSourceSUEPPS_Inserted" OnUpdated="SqlDataSourceSUEPPS_Updated" OnDeleted="SqlDataSourceSUEPPS_Deleted"
                                SelectCommand="SELECT [IdVariable], [NombreVariable], [Descripcion], [Unidad], [CreadoPor], [FechaCreacion], [ActualizadoPor], [FechaActualizacion], [Activo] FROM [Variables] WHERE [Activo]=1 ORDER BY  [FechaCreacion] "></asp:SqlDataSource>
                        </dx:ContentControl>
                    </ContentCollection>
                </dx:TabPage>
                        ...
                        <dx:ContentControl>
                                    ...
                                    <td>
                                        ...
                                        <dx:ASPxGridView ID="ASPxGridViewIndicadores" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSourceIndicadores" KeyFieldName="IdIndicador" SettingsBehavior-AllowFocusedRow="true" Settings-ShowFilterRow="true">
                                            <Columns>
                                                ...
                                                <dx:GridViewDataTextColumn FieldName="DescripcionIndicador" VisibleIndex="3" Caption="Indicador">
                                                    <Settings AutoFilterCondition="Contains" />
                                                </dx:GridViewDataTextColumn>
                                                <dx:GridViewDataTextColumn FieldName="Acción" ShowInCustomizationForm="True" VisibleIndex="4" Caption="Acción" UnboundType="String">
                                                    <DataItemTemplate>
                            ...
                            <div style="border: double">
                                <table>
                                    <tr>
                                        <td>
                                            <dx:ASPxTextBox ID="ASPxTextBoxIndicador" runat="server" Width="370px" ReadOnly="true"></dx:ASPxTextBox>
                                        </td>
                                        <td>
                                            <dx:ASPxLabel ID="ASPxLabelIgual" runat="server" Text="="></dx:ASPxLabel>
                                        </td>
                                        <td>
                                            <dx:ASPxTextBox ID="ASPxTextBoxNumerador" runat="server" Width="170px" ReadOnly="true"></dx:ASPxTextBox>
                                        </td>
                                        <td>
                                            <dx:ASPxLabel ID="ASPxLabelPor" runat="server" Text="X"></dx:ASPxLabel>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <dx:ASPxTextBox ID="ASPxTextBox1" runat="server" Width="170px" Visible="false"></dx:ASPxTextBox>
                                        </td>
                                        <td>
                                            <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="ASPxLabel" Visible="false"></dx:ASPxLabel>
                                        </td>
                                        <td>
                                            <dx:ASPxTextBox ID="ASPxTextBoxDenominador" runat="server" Width="170px" ReadOnly="true"></dx:ASPxTextBox>
                                        </td>
                                        <td>
                                ...
                                <table>
                                    <tr>
                                        <td>
                                            <dx:ASPxLabel ID="ASPxLabelDescripcion" runat="server" Text="Descripción"></dx:ASPxLabel>
                                        </td>
                                        <td>
                            ...
                            <asp:SqlDataSource runat="server" ID="SqlDataSourceFormulas" ConnectionString='<%$ ConnectionStrings:SUEPPSConnectionString %>'
                                SelectCommand="SELECT * FROM [FormulaIndicador] WHERE [Activo]=1"></asp:SqlDataSource>
