...
<%-- ######################################################################################################################################################################################### --%>
        ...
        <ContentCollection>
            <dx:ContentControl>
                <dx:ASPxGridView ID="ASPxGridViewDefinicionVariables" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSourceSUEPPS" KeyFieldName="IdVariable" SettingsBehavior-AllowFocusedRow="true">
                <Columns>
                    <dx:GridViewDataTextColumn FieldName="IdVariable" ReadOnly="True" VisibleIndex="0" Visible="false">
                        <EditFormSettings Visible="False"></EditFormSettings>
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="NombreVariable" VisibleIndex="1" Caption="Nombre"></dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="Descripcion" VisibleIndex="2"></dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="Unidad" VisibleIndex="3"></dx:GridViewDataTextColumn>
        ...
        <ContentCollection>
            <dx:ContentControl>
                ...
                <tr>
                    <td>
                        <%-- Grid Indicadores --%>
                        <dx:ASPxGridView ID="ASPxGridViewIndicadores" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSourceIndicadores" KeyFieldName="IdIndicador" SettingsBehavior-AllowFocusedRow="true">
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn FieldName="DescripcionIndicador" VisibleIndex="3" Caption="Indicador"></dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn FieldName="Acción" ShowInCustomizationForm="True" VisibleIndex="4" Caption="Acción" UnboundType="String">
                                    <DataItemTemplate>
                        ...
                        <asp:SqlDataSource runat="server" ID="SqlDataSourceIndicadores" ConnectionString='<%$ ConnectionStrings:SUEPPSConnectionString %>' SelectCommand="SELECT [IdIndicador], [IdSectorIndicador], [IdTipoDeIndicador], [DescripcionIndicador] FROM [Indicadores]"></asp:SqlDataSource>
                    </td>
                    <td>
                    ...
                    <td>
                        <dx:ASPxGridView ID="ASPxGridViewVariables" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSourceVariables" KeyFieldName="IdVariable" SettingsBehavior-AllowFocusedRow="true">
                            <Columns>
            ...
            <dx:ASPxGridView ID="ASPxGridViewFormulas" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSourceFormulas" KeyFieldName="IdFormulaIndicador" SettingsBehavior-AllowFocusedRow="true">
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="DescripcionFormula" VisibleIndex="7" Caption="Descripción"></dx:GridViewDataTextColumn>
