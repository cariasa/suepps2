...
Partial Class Demo_Demo
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Using dtMOCA As System.Data.DataTable = fMOCA.CheckPageAccess(0.02)
            If dtMOCA.Rows.Count() > 0 Then
                ...
                hlNuevo.Visible = dtMOCA.Rows.Item(0).Item("AllowAdd")
        ...
        'Carga del Grid
        lblNoUserOnline.Text = "Total Usuarios en linea: " + Membership.GetNumberOfUsersOnline().ToString
        Dim users As MembershipUserCollection = Membership.GetAllUsers
        gvUsuariosEnLinea.DataSource = users
        gvUsuariosEnLinea.DataBind()
    End Sub

    Protected Sub gvUsuariosEnLinea_CommandButtonInitialize(sender As Object, e As DevExpress.Web.ASPxGridView.ASPxGridViewCommandButtonEventArgs) Handles gvUsuariosEnLinea.CommandButtonInitialize
