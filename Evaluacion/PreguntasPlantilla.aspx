<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PreguntasPlantilla.aspx.vb" Inherits="Cuantitativo_PreguntasPlantilla"  %>
...
<body>
    <form id="form1" runat="server" onload="form1_Load">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server"  OnInserted="SqlDataSource1_Inserted"
            ...
            SelectCommand="SELECT * FROM [PreguntasPorPlantilla] WHERE [Activo]=1 and [IdPlantilla]= @IdPlantilla"
