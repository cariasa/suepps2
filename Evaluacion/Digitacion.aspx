...
<asp:Content ID="cBody" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div>
        ...
        <dx:ASPxLabel ID="ASPxLabel2" runat="server" Text="Código FSU" AssociatedControlID="ASPxTextBoxFSU" ></dx:ASPxLabel>
        <dx:ASPxTextBox ID="ASPxTextBoxFSU" runat="server" Width="170px"></dx:ASPxTextBox>

        <dx:ASPxLabel ID="ASPxLabel3" runat="server" Text="IdVivienda" AssociatedControlID="ASPxTextBoxIdVivienda" ></dx:ASPxLabel>
        <dx:ASPxTextBox ID="ASPxTextBoxIdVivienda" runat="server" Width="170px"></dx:ASPxTextBox>

        <dx:ASPxLabel ID="ASPxLabel4" runat="server" Text="IdHogar" AssociatedControlID="ASPxTextBoxIdHogar" ></dx:ASPxLabel>
