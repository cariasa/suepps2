<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PlanificacionMapa.aspx.vb" Inherits="Consultas_PlanificacionMapa"  MasterPageFile="~/Site.master"%>
...
<asp:Content ID="cBody" ContentPlaceHolderID="MainContent" Runat="Server">
    <uc1:MOCA_UE runat="server" ID="MOCA_UE01" />
        <table>
                            ...
                            <dx:ASPxGridView ID="GridPrograma" runat="server" ClientInstanceName="GridPrograma" OnLoad="GridPrograma_Load"  AutoGenerateColumns="False" DataSourceID="SqlPrograma"  OnCustomCallback="GridPrograma_CustomCallback" KeyFieldName="codigo_ficha" Width="100%" Settings-ShowFilterRow="true">
                                ...
                                <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn FieldName="Acción" ShowInCustomizationForm="True" VisibleIndex="4" Caption="Acción" UnboundType="String">
                                      <DataItemTemplate>
                                          <asp:LinkButton id="link1"  Text="Ver Mapa" runat="server" OnClick="send" /> 
                                      </DataItemTemplate>
