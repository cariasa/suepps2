<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PreguntasInstrumento.aspx.vb" Inherits="Cuantitativo_PreguntasInstrumento" %>
...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" OnInserted="SqlDataSource1_Inserted"
            ...
            SelectCommand="SELECT * FROM [PreguntasPorInstrumento] WHERE [Activo]=1 and [IdInstrumentoDeEvaluacion]= @IdInstrumentoDeEvaluacion"
